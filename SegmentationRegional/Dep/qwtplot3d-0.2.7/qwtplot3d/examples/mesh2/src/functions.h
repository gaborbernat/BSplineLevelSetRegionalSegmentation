...
class LevelSetFunctionSurface : public Function
{
public:

	LevelSetFunctionSurface(SurfacePlot& pw)
	:Function(pw)
	{
	}
...
//	QString name() const {return "Almost {\\it LevelSetFunctionSurface}\\,:\\quad$\\frac{\\ln((1-x)^2 + 100(y-x^2)^2)}{8}$";}
};
